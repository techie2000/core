...
class OptionsFlowManager(data_entry_flow.FlowManager):
    ...
    async def _async_get_config_entry(self, config_entry_id: str) -> ConfigEntry:
    ...
    async def async_create_flow(
        ...
        *,
        ...
        """
        entry = await self._async_get_config_entry(handler_key)
    ...
    async def _async_setup_preview(self, flow: data_entry_flow.FlowHandler) -> None:
        ...
        entry = await self._async_get_config_entry(flow.handler)
